...
function ReporterRegistation() {
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>Alikidi.com - Reporter Registation </title>
                ...
                <form onSubmit={handlesubmit}>
                  <div className="row">
                    ...
                    <div className="col-md-12 d-flex justify-content-center align-items-center">
                      ...
                      <div className="form-group col-md-6">
                        <label>KYC Document (Aadhar)</label>
                        <input
                          className="form-control"
                          type="text"
                    ...
                    <div className="col-md-12 d-flex justify-content-center align-items-center">
                      <div className="form-group col-md-6">
                        ...
                        <p className="text-center mt-2">
                          uploading image size should be less then 1MB*
                        </p>
                        <div>
                          {isreporterKycImageLoading ? (
                            <div></div>
...
export default ReporterRegistation;
